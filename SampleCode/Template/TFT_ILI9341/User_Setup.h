...
#define TFT_CS   LCD_RS     //10  // Chip select control pin
#define TFT_DC   LCD_RS     //8  // Data Command control pin
#define TFT_RST  LCD_RST    //7  // Reset pin (could connect to Arduino RESET pin)
