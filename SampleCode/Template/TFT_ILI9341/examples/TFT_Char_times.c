...
void setup_TFT_Char_times(void) {
  // init();
  // if(g_InitOnce == 0)
  //     g_InitOnce = 1;
  // else
...
void loop_TFT_Char_times(void) {
  ...
  for (i = 0; i < 1000; i++) {
    drawNumber(i, 100, 80, 1);
  }

  drawTime = millis() - drawTime;

  setTextColor2(TFT_RED, TFT_BLACK);
  drawFloat(drawTime / 2890.0, 3, 50, 180, 4);
  if (drawTime < 100) drawString("Font 1 not loaded!", 50, 210, 4);
  ...
  setTextColor2(TFT_RED, TFT_BLACK);
  drawFloat(drawTime / 2890.0, 3, 50, 180, 4);
  if (drawTime < 200) drawString("Font 2 not loaded!", 50, 210, 4);
  ...
  setTextColor2(TFT_RED, TFT_BLACK);
  drawFloat(drawTime / 2890.0, 3, 50, 180, 4);
  if (drawTime < 200) drawString("Font 4 not loaded!", 50, 210, 4);
  ...
  setTextColor2(TFT_RED, TFT_BLACK);
  drawFloat(drawTime / 2890.0, 3, 50, 180, 4);
  if (drawTime < 200) drawString("Font 6 not loaded!", 50, 210, 4);
  ...
  setTextColor2(TFT_RED, TFT_BLACK);
  drawFloat(drawTime / 2890.0, 3, 50, 180, 4);
  if (drawTime < 200) drawString("Font 7 not loaded!", 50, 210, 4);
  
  delay(4000);
  fillScreen(TFT_YELLOW);
  setTextColor2(TFT_WHITE, TFT_BLACK);
    drawTime = millis();

  for (i = 0; i < 1000; i++) {
    drawNumber(i, 100, 80, 8);
  }
  ...
  setTextColor2(TFT_RED, TFT_BLACK);
  drawFloat(drawTime / 2890.0, 3, 50, 180, 4);
  if (drawTime < 200) drawString("Font 8 not loaded!", 50, 210, 4);
